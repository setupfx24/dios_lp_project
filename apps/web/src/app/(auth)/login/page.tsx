...
const BUBBLES = [
  { left: 3, size: 42, dur: 8, delay: 0 },
  { left: 8, size: 16, dur: 6, delay: 2 },
  { left: 13, size: 28, dur: 9, delay: 1 },
  { left: 18, size: 12, dur: 5, delay: 3 },
  { left: 23, size: 50, dur: 11, delay: 0 },
  { left: 28, size: 20, dur: 7, delay: 4 },
  { left: 33, size: 14, dur: 6, delay: 1 },
  { left: 38, size: 34, dur: 10, delay: 2 },
  { left: 43, size: 18, dur: 6, delay: 5 },
  { left: 48, size: 46, dur: 11, delay: 0 },
  { left: 52, size: 14, dur: 5, delay: 3 },
  { left: 57, size: 26, dur: 9, delay: 1 },
  { left: 62, size: 12, dur: 5, delay: 4 },
  { left: 67, size: 38, dur: 10, delay: 2 },
  { left: 72, size: 18, dur: 7, delay: 0 },
  { left: 77, size: 48, dur: 11, delay: 3 },
  { left: 82, size: 14, dur: 6, delay: 1 },
  { left: 87, size: 30, dur: 9, delay: 5 },
  { left: 92, size: 16, dur: 6, delay: 2 },
  { left: 97, size: 40, dur: 10, delay: 0 },
  { left: 6, size: 14, dur: 5, delay: 4 },
  { left: 21, size: 22, dur: 8, delay: 6 },
  { left: 36, size: 12, dur: 5, delay: 2 },
  { left: 45, size: 30, dur: 9, delay: 7 },
  { left: 60, size: 16, dur: 6, delay: 3 },
  { left: 70, size: 24, dur: 8, delay: 5 },
  { left: 80, size: 12, dur: 5, delay: 1 },
  { left: 90, size: 34, dur: 10, delay: 6 },
  { left: 50, size: 18, dur: 7, delay: 8 },
  { left: 30, size: 20, dur: 7, delay: 4 },
  { left: 64, size: 14, dur: 6, delay: 2 },
  { left: 11, size: 28, dur: 9, delay: 7 },
];
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-red-950 via-zinc-950 to-black p-6 text-white">
      ...
      <div className="absolute left-8 top-7 flex items-center gap-3">
        ...
        <span className="text-xl font-semibold text-white">SwissCresta</span>
      </div>
